...
var incompleteTaskHolder=document.querySelector(".task-list__inner_incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".task-list__inner_completed");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="button task-list__button task-list__button_edit";

    deleteButton.className="button task-list__button task-list__button_delete";
